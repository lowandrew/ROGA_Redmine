...
class Salmonella_Automator(Automate):
    ...
    def print_tables_to_docx(self):
        import docx
        doc = docx.Document("salmonella_feed_template.docx")
        j = 2
        ...
        for name in self.names:
            ...
            Automate.add_text_to_cell(self.metadata[name]["serogroup"], j, 2, doc.tables[2])
            Automate.add_text_to_cell(self.metadata[name]["h1"], j, 3, doc.tables[2])
            Automate.add_text_to_cell(self.metadata[name]["h2"], j, 4, doc.tables[2])
